...
class TestModel3DSpecific:
    ...
    def test_repr_all_false(self):
        ...
        model = Model3D(name="test", cad="minimal.step", with_shapes=False, with_channels=False)
        repr_str = repr(model)
...
"""
    ...
    def test_json_serialization_completeness(self):
        ...
        expected_keys = {"__classname__", "name", "cad", "with_shapes", "with_channels"}
    ...
    def test_write_to_json_file_handling(self):
        ...
        model = Model3D(name="test", cad="file_test.step")
...
class TestModel3DPerformance:
    ...
    def test_large_filename_performance(self):
        ...
        def create_model():
            return Model3D(name="test", cad=large_filename)
    ...
    def test_repr_performance(self):
        ...
        model = Model3D(name="test", cad="x" * 1000 + ".step")
...
class TestModel3DErrorHandling:
    ...
    def test_write_to_json_file_error(self):
        ...
        model = Model3D(name="test", cad="error_test.step")
    ...
    def test_to_json_with_serialization_error(self):
        ...
        model = Model3D(name="test", cad="serialization_test.step")
...
class TestModel3DCompatibility:
    ...
    def test_json_special_characters_escaping(self):
        ...
        model = Model3D(name="test", cad=special_cad)
    ...
    def test_comparison_operations(self):
        ...
        model1 = Model3D(name="test", cad="same.step", with_shapes=True, with_channels=False)
        model2 = Model3D(name="test", cad="same.step", with_shapes=True, with_channels=False)
        model3 = Model3D(name="test", cad="different.step", with_shapes=True, with_channels=False)
