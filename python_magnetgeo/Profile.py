...
class Profile(YAMLObjectBase):
    ...
    def __repr__(self):
        ...
        """
        return (f"{self.__class__.__name__}(cad={self.cad!r}, "
    ...
    def from_dict(cls, values: dict, debug: bool = False):
        ...
        if debug:
            print(f"Creating Profile from dict: cad={cad}, "
    ...
    def generate_dat_file(self, output_dir: str = ".") -> Path:
        ...
        has_labels = (self.labels is not None and 
                     len(self.labels) > 0 and 
                     any(label != 0 for label in self.labels))
...
if __name__ == "__main__":
    ...
    json_str = profile_no_labels.to_json(indent=2)
    print(json_str)
